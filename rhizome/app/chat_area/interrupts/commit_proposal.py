"""CommitProposalInterruptModel — adapter giving ``CommitProposalModel`` the chat-area interrupt
...
class CommitProposalInterruptModel(CommitProposalModel, InterruptModelBase):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        # Interrupts are interactive feed entries — opt into the chat area's ctrl+up/ctrl+down rotation.
