...
Interrupts are feed-native sub-VMs: they live as siblings of AgentMessage in the chat area's feed,
...
The future lives on the VM, not on the widget. ``present_interrupt`` on the chat area awaits
