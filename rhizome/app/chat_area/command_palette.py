"""Slash-command palette — sub-VM + view used by the MVVM chat area.

The palette knows nothing about the chat area: it holds the conversation's ``CommandRegistryService``
