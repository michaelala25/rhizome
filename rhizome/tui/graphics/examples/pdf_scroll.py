...
Contrast with ``pdf_viewer``, which re-fits the whole page into its box: there, font-zoom changes pixel
density but never apparent size; here it grows the footprint and you scroll around the larger page.
...
class PdfScrollApp(App):
    ...
    def compose(self) -> ComposeResult:
        yield graphics.ScrollImage(id="page")
