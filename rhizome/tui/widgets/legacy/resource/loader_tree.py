...
class LoaderTree(Tree[NodeData]):
    ...
    def render_label(
        ...
        if effective == ResourceLoadType.CONTEXT:
            suffix += "  ctx"
            ...
            if isinstance(data, Resource):
                ...
                if suffix:
                    ...
                    if effective == ResourceLoadType.CONTEXT:
                        ...
                        text.append(suffix, style=_META)
                elif effective == ResourceLoadType.CONTEXT:
                    text.append("  ctx", style=_CTX_TAG)
        elif suffix:
