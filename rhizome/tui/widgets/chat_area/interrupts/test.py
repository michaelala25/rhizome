...
@register_feed_view(TestInterruptModel)
class TestInterrupt(NavigableFeedItemViewBase[TestInterruptModel]):
    """Single-Static projection of ``TestInterruptModel``. Up/Down move the cursor; Enter confirms. The
