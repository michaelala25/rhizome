...
from rhizome.agent_legacy.builder import build_root_agent
from rhizome.agent_legacy.context import AgentContext
from rhizome.agent_legacy.middleware.agent_mode import AgentModeMiddleware, SYSTEM_PROMPT_MESSAGE_ID
from rhizome.agent_legacy.modes import MODE_REGISTRY
from rhizome.agent_legacy.tools.app import build_app_tools
from rhizome.agent_legacy.tools.core import build_core_tools
from rhizome.agent_legacy.tools.flashcard_proposal import build_flashcard_proposal_tools
from rhizome.agent_legacy.tools.guide import build_guide_tools
from rhizome.agent_legacy.tools.resources import build_resource_tools
from rhizome.agent_legacy.tools.review import build_review_tools
from rhizome.agent_legacy.tools.sql import build_sql_tools
from rhizome.agent_legacy.utils import TokenUsageData, compute_chat_model_max_tokens

from rhizome.agent_legacy.subagents.commit import build_commit_subagent, build_commit_subagent_tools
from rhizome.agent_legacy.subagents.flashcard_validator import (
    ...
    async def stream(
        ...
        *,
        ...
        if self._pending_commit_payload is not None:
            from rhizome.agent_legacy.state import CommitProposalState
