...
``rhizome.agent_legacy.tools.flashcard_proposal``) — this module only defines the subagent
...
from rhizome.agent_legacy.middleware import AnthropicPenultimateCacheMiddleware
from rhizome.agent_legacy.subagents.base import StructuredSubagent
