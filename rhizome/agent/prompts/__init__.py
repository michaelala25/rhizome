"""Prompt content for the new agent stack: one fixed system prompt, the mode/workflow guides injected as
context messages, and the per-mode tool allowlists rendered into mode-switch headers."""
